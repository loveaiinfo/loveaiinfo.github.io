...
AUTHORS = {
  'loveai': {
    ...
    'bio': "Graduated in Computer Science and Engineering, but currently working with GNU/Linux infrastructure and in the spare time I'm an Open Source programmer (Python and C), a drawer and author in the LOVEAI Blog.",
    'links': [
        ("GitHub", "github", "#"),
        ("Twitter", "twitter", "#"),
...
SUBTITLE = "LOVEAI's BLOG"
SUBTEXT = "I'm a drawer and author in the LOVEAI Blog."
COPYRIGHT = "© 2025 LOVEAI. All rights reserved."